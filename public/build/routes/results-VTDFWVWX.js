...
function Results() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", null, "gm"), /* @__PURE__ */ React.createElement("h1", null, owner), assets.map((nft) => /* @__PURE__ */ React.createElement("div", {
    key: nft.tokenId
  }, /* @__PURE__ */ React.createElement("h1", null, nft.imageUrl), /* @__PURE__ */ React.createElement("p", null, nft.tokenUrl), /* @__PURE__ */ React.createElement("p", null, nft.collectionName))));
}
export {
  Results as default
};
//# sourceMappingURL=/build/routes/results-VTDFWVWX.js.map
